  ...
  static get styles() {
    return css`
      ha-card {
        ...
        isolation: isolate; /* FIX: Crea un nuovo contesto di stacking */
        overflow: visible; /* Assicura che i badge non vengano tagliati dal contenitore */
      }
      ...
      .gauges-container {
        ...
        margin-bottom: 30px;
        margin-top: 10px; /* Spazio extra per evitare tagli in alto */
      }
      ...
      .gauge-svg-wrapper {
        ...
        height: 70px;
        margin-bottom: 5px;
        overflow: visible; /* Lascia uscire il badge */
      ...
      .badge-icon-wrapper {
        ...
        z-index: 2; /* Sta sopra al cerchio, ma sotto l'header grazie a isolation */
